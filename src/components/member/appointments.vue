<template>
  ...
  <div>
    <!-- <h1>Make Payment</h1> -->
    <iframe v-if="appointmentAdded" ref="myIframe" width="600" height="400" frameborder="0" allowfullscreen></iframe>
  </div>
                  ...
                  <div v-if="appointments.length > 0" class="table-responsive">
                    ...
                    >
                          ...
                          <td>
                            ...
                            <a class="text-danger me-2" @click="deleteAppointment(appointment.appointment_id)"><i
