      ...
      <div class="container-fluid">
        <div class="topnav rtl-ps-none" id="" data-perfect-scrollbar="" data-suppress-scroll-x="true">
          ...
          <ul v-if="hasGroupID('3')" class="menu float-start">
            ...
            <li>
              <div>
                <div><label class="toggle" for="drop-2"> Appointments</label><router-link to="/vendor-appointments"><i class="nav-icon me-2 i-Calendar-3 text-primary"></i> Appointments</router-link></div>
              </div>
            </li>
            <li>
              <div>
                <div><label class="toggle" for="drop-2"> Services</label><router-link to="/vendor-services"><i class="nav-icon me-2 i-Bag-Coins text-primary"></i> Services</router-link></div>
              </div>
            </li>
            <li>
              <div>
                <div><label class="toggle" for="drop-2"> Service Pricing</label><router-link to="/vendor-service-pricing"><i class="nav-icon me-2 i-Friendster text-primary"></i> Service Pricing</router-link></div>
              </div>
            </li>
          </ul>
        </div>
