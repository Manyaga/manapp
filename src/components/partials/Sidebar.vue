                       ...
                       <!-- admin -->
                        <ul class="menu float-start">
                            ...
                            <li>
                                <div>
                                    <div>
                                        <label class="toggle" for="drop-2"> Apppointments</label><router-link to="/Services"><i class="nav-icon me-2 i-Bag-Coins"></i> Appointments</router-link>
                                    </div>
                                </div>
                            </li>
                            <li>
                                <div>
                                    <div>
                                        <label class="toggle" for="drop-2">Services</label><a href="#"><i class="nav-icon me-2 i-Full-Cart"></i> Services</a>
                                        <input id="drop-2" type="checkbox" />
                                        <ul>
                                            <li><router-link to="/Services"><i class="nav-icon me-2 i-Full-Cart"></i> Services</router-link></li>
                                            <li><router-link to="/service-interests"><i class="nav-icon me-2 i-Tag-4"></i><span class="item-name"> Service Interest</span></router-link></li>
                                            <li><router-link to="/Service-pricing"><i class="nav-icon me-2 i-Big-Data"></i><span class="item-name"> Pricing</span></router-link></li>
                                        </ul>
                                    </div>
                                </div>
                            </li>
                            ...
                            <li>
                                <div>
                                    <div>
                                        <label class="toggle" for="drop-2">Interests</label><a href="#"><i class="nav-icon me-2 i-gear"></i> Interests</a>
                                        <input id="drop-2" type="checkbox" />
                                        <ul>
                                            <li><router-link to="/interest-categories"><i class="nav-icon me-2 i-Map-Marker"></i><span class="item-name">Categories</span></router-link></li>
                                            <li><router-link to="/service-interests"><i class="nav-icon me-2 i-Map2"></i><span class="item-name">Service Interest</span></router-link></li>
                                        </ul>
                                    </div>
                                </div>
                            </li>
                                ...
                                <div>
                                    <div>
                                        ...
                                        <ul>
                                            ...
                                            <li><router-link to="/states"><i class="nav-icon me-2 i-Geo21"></i><span class="item-name">States</span></router-link></li>
                                            <li><router-link to="/cities"><i class="nav-icon me-2 i-Map2"></i><span class="item-name">Cities</span></router-link></li>
                                            <li><router-link to="/logs"><i class="nav-icon me-2 i-Financial"></i><span class="item-name">Logs</span></router-link></li>
                                            ...
                                            <li><router-link to="/user-groups"><i class="nav-icon me-2 i-Map2"></i><span class="item-name">User Groups</span></router-link></li>
