<template>
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="verifyModalContent_title">Add Vendor</h5>
                    ...
                    <div class="modal-body">
                        <div class="row row-xs">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <Field name="postalCode" class="form-control" id="postalCode" type="text"
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <Field name="zipCode" class="form-control" id="zipCode" type="text"
    ...
    <div class="modal fade" id="editModalContent" tabindex="-1" role="dialog" aria-labelledby="editModalContent"
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="editModalContent_title">Edit Vendor</h5>
                    <button class="btn btn-close" type="button" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
        ...
        <div class="main-content-wrap d-flex flex-column">
            <div class="main-content">
                <button class="btn btn-info text-white ul-btn-raised--v2 m-1  float-end" type="button"
                    ...
                    <i class="nav-icon i-add text-primary text-white fw-bold"></i> ADD VENDOR</button>
                <Breadcrumbs />
                            ...
                            <table class="table text-center" id="member_table" style="width: 100%">
                                ...
                                <tbody>
                                    <tr v-for="(member, index) in userUserGroups" :key="member.service_id">
                                        ...
                                        <td>{{ member.user_id.country_id.country_name.toUpperCase() }}</td>
                                        <td>
        ...
        addUser(user) {
            ...
            this.$apollo
                ...
                .then(response => {
                    ...
                    this.$swal({
                        title: 'Vendor added sucessfully',
                        position: 'top-end',
                        icon: 'success',
        ...
        editUser(user) {
            ...
            this.$apollo
                ...
                .then(response => {
                    ...
                    this.$swal({
                        title: 'Vendor updated sucessfully',
                        position: 'top-end',
                        icon: 'success',
                        showConfirmButton: false,
                        timer: 2000
            ...
            this.$swal({
                ...
                if (result.isConfirmed) {
                    this.$apollo
                        ...
                        .then(response => {
                            this.$swal({
                                title: 'Vendor deleted sucessfully',
                                position: 'top-end',
                                icon: 'success',
                                showConfirmButton: false,
                                timer: 2000
