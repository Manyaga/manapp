<template>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="verifyModalContent_title">Add Service Interest</h5>
                    <button class="btn btn-close" type="button" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <Form @submit="addServiceInterest" :validation-schema="schema" class="user">
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <label for="subcategory_id" class="form-control-label">Interest Subcategory</label>
                            <Field name="subcategory_id" class="form-control form-control-lg" v-model="subcategory_id"
                                as="select">
                                <option value="">-- Interest Subcategory--</option>
                                <option v-for="sub_category in InterestSubcategories" :value="sub_category.sub_category_id"
                                    :key="sub_category.sub_category_id">
                                    {{ sub_category.name }}
                                </option>
                            </Field>
                            <ErrorMessage name="subcategory_id" class="text-danger py-3 text-sm" />
                        </div>
    ...
    <div class="modal fade" id="editModalContent" tabindex="-1" role="dialog" aria-labelledby="editModalContent"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="editModalContent_title">Edit Service Interest</h5>
                    <button class="btn btn-close" type="button" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <Form @submit="editServiceInterest" :validation-schema="schema" class="user">
                    <div class="modal-body">
                        <div class="form-group">
                            <label for="service_id" class="form-control-label">Service</label>
                            <Field name="service_id" class="form-control form-control-lg" v-model="service_id" as="select">
                    ...
                    <div class="row list-grid">
                        <div class="list-item col-lg-3 col-xl-3 mt-3" v-for="product in products" :key="product._id">
                            <div class="card o-hidden mb-4 d-flex flex-column">
                                <div class="list-thumb d-flex"><img alt=""
                                        src="../../assets/images/products/speaker-1.jpg" /></div>
                                <div class="flex-grow-1 d-bock">
                                    <div
                                        ...
                                        <p class="m-0 text-muted text-small w-15 w-sm-100">Quantity {{ product.quantity }}
                                        </p>
                                        ...
                                        <div>
                                            ...
                                            <button class="btn btn-outline-danger ul-btn-raised--v2 m-1  float-end"
                                                type="button" @click="deleteServiceInterest(product._id)">
                                                DELETE
                                            </button>
                                        </div>
                                    </div>
