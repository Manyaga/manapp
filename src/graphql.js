...
export const EDIT_COUNTRY_MUTATION = gql`
  mutation UpdateCountry($updateCountryId: Int!, $input: CountryInput) {
...
export const EDIT_STATE_MUTATION = gql`
  mutation UpdateState($updateStateId: Int!, $input: StateInput) {
...
export const ALL_USERS_QUERY = gql`
  query Users($status: String, $countryId: ID, $offset: Int, $limit: Int) {
    users(
      status: $status
...
export const EDIT_SERVICE_INTEREST_MUTATION = gql`
  mutation UpdateServiceInterest(
    $serviceInterestId: Int!
    $input: ServiceInterestsInput
  ) {
...
export const EDIT_INTEREST_SUBCATEGORY_MUTATION = gql`
  mutation UpdateInterestSubcategory(
    $subcategoryId: Int!
    $input: InterestSubcategoryInput!
  ) {
...
export const ADD_INTEREST_CATEGORY_MUTATION = gql`
  mutation Mutation($input: InterestCategoryInput!) {
...
export const EDIT_INTEREST_CATEGORY_MUTATION = gql`
  mutation UpdateInterestCategory(
    $categoryId: Int!
    $input: InterestCategoryInput!
  ) {
    updateInterestCategory(categoryId: $categoryId, input: $input) {
      category_id
      name
    }
  }
