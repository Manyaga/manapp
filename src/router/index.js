...
const routes = [
  ...
  { path: "/service-pricings", component: () => import("@/components/admin/servicePricings.vue"), beforeEnter: authGuard, meta: { title: "Service Pricing" },},
  { path: "/interest-categories", component: () => import("@/components/admin/interestCategories.vue"), beforeEnter: authGuard, meta: { title: "Interest Categories" },},
  { path: "/interest-sub-categories", component: () => import("@/components/admin/interestSubcategories.vue"), beforeEnter: authGuard, meta: { title: "Interest Sub-Categories" },},

  { path: "/user-interests", component: () => import("@/components/admin/userInterests.vue"), beforeEnter: authGuard, meta: { title: "User Interests" },},
